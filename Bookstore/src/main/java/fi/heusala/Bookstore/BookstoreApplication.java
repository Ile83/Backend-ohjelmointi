...
public class BookstoreApplication {
	 ...
	 * // tallennetaan muutama kirja Private string title, author, int
	 * publicationYear,
	 * // String isbn, double price
	 * bookRepository.save(new Book("Kirja1 ", "Kirjailija Kirjoittaja1", 2001,
	 * "ISBN1", 11, category1));
	 * bookRepository.save(new Book("Kirja2 ", "Kirjailija Kirjoittaja2", 2002,
	 * "ISBN2", 12, category2));
	 * bookRepository.save(new Book("Kirja3 ", "Kirjailija Kirjoittaja3", 2003,
	 * "ISBN3", 13, category3)); // kehitysvaiheessa,
	 * // mutta ei
	 * // tuotannossa
	 * 
	 * // Create users: admin/admin user/user
	 * AppUser user1 = new AppUser("user",
	 * "$2a$10$k3dXqAiLCXzJeMz7rXKH0OgqMnSwu6/SeLej2jSrrlAJcpAxrwZ3u", "USER");
	 * AppUser user2 = new AppUser("admin",
	 * "$2a$10$1AcJdbfKMbL9.9e8JA1TyOWChGUJAwftbvDSQBdX0R3oodOv9dyuG",
	 * "ADMIN");
	 * 
	 ...
	 * System.out.println(book.toString()); // konsoliin ei kyllä logaudu oikeat
	 * tiedot.
	 * 
	 * System.out.println("Kirjan tiedot: " + book.toString()); // konsoliin ei
	 * kyllä logaudu oikeat tiedot.
